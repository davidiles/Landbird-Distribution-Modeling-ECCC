...
for (i in 1:nrow(species_list)){
  ...
  print(species_name)
  # if (file.exists(paste0("../Output/Prediction_Maps/Relative_Abundance/",species_name,"_change_q50_norange.png"))) next
  ...
  png(paste0("../Output/Prediction_Maps/Relative_Abundance/",species_name,"_OBBA2_q50_norange.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(OBBA2_plot_q50)
  dev.off()
  ...
  png(paste0("../Output/Prediction_Maps/Relative_Abundance/",species_name,"_OBBA3_q50_norange.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(OBBA3_plot_q50)
  dev.off()
  ...
  png(paste0("../Output/Prediction_Maps/Relative_Abundance/",species_name,"_change_q50_norange.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(change_plot_q50)
  dev.off()
