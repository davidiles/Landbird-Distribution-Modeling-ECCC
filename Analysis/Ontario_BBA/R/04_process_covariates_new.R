...
waterbody_src      <- file.path(paths$data, "Spatial", "Ontario_Hydro_Network_(OHN)_-_Waterbody",
                            "Ontario_Hydro_Network_(OHN)_-_Waterbody.shp")

watercourse_src      <- file.path(paths$data, "Spatial", "Ontario_Hydro_Network_(OHN)_-_Watercourse",
